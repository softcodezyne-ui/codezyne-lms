...
// Corrected icon mapping from lucide-react to react-icons
const iconMappings = {
  // Basic icons that exist in react-icons/lu
  'X': 'LuX',
  'Menu': 'LuMenu',
  ...
  // Icons that need different mappings or don't exist in Lu set
  'Loader2': 'LuLoader', // LuLoader2 doesn't exist, use LuLoader
  ...
  // Icons that don't exist in Lu set - use alternative icons
...
console.log('Starting icon mapping fixes...');
processDirectory('./src');
console.log('Icon mapping fixes completed!');
